...
start:
	...
	int	21h
	cmp	byte ptr laikas+2, "9"	;Tikriname ar sekundės neviršijo 9
	jne	maz1					;Jei ne tęsti
	mov	byte ptr laikas+2, "0"	;Priešingu atveju įrašome 0
	cmp	byte ptr laikas+1, "9"	;Tikriname ar sekundžių dešimtys neviršijo 9 dešimčių
	jne	maz2					;Jei ne tęsti
	mov	byte ptr laikas+1, "0"	;Priešingai 0
	cmp	byte ptr laikas, "9"	;Tikriname ar sekundžių šimtai neviršijo 9 šimtų
	jne	maz3				;
	mov	byte ptr laikas, "0"
	jmp	short toliau
