...
start:
	...
	int	21h
	jmp	short toliau
maz3:	add	byte ptr offset laikas, 1	;Didiname sekundžių šimtus 1
	jmp	short toliau
maz2:	add	byte ptr offset laikas+1, 1	;Didiname sekundžių dešimtis 1
	jmp	short toliau
maz1:	add	byte ptr offset laikas+2, 1	;Didiname sekundžių vienetus 1
toliau:	pop	bx
	jmp	short start
	ret
